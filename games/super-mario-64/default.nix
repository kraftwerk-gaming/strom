...
(self.lib.retroarch.apply {
  ...
  preHook = ''
    mkdir -p ~/.strom/super-mario-64/saves \
             ~/.strom/super-mario-64/states
  '';
  settings.savefile_directory = "~/.strom/super-mario-64/saves";
  settings.savestate_directory = "~/.strom/super-mario-64/states";
