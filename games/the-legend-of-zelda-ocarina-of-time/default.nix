...
(self.lib.retroarch.apply {
  ...
  preHook = ''
    mkdir -p ~/.strom/the-legend-of-zelda-ocarina-of-time/saves \
             ~/.strom/the-legend-of-zelda-ocarina-of-time/states
  '';
  settings.savefile_directory = "~/.strom/the-legend-of-zelda-ocarina-of-time/saves";
  settings.savestate_directory = "~/.strom/the-legend-of-zelda-ocarina-of-time/states";
